...
class V2paymentsAggregatorInformation implements ArrayAccess
{
    ...
    protected static $Types = [
        'aggregatorId' => 'string',
        'name' => 'string',
        'subMerchant' => '\CyberSource\Model\V2paymentsAggregatorInformationSubMerchant'
    ];
    ...
    /**
     * Gets subMerchant
     * @return \CyberSource\Model\V2paymentsAggregatorInformationSubMerchant
     */
    ...
    /**
     * Sets subMerchant
     * @param \CyberSource\Model\V2paymentsAggregatorInformationSubMerchant $subMerchant
     * @return $this
     */
