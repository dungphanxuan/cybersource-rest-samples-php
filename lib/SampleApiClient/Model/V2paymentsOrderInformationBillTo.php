...
class V2paymentsOrderInformationBillTo implements ArrayAccess
{
    ...
    /**
     * Sets buildingNumber
     * @param string $buildingNumber Building number in the street address.  This field is supported only for:  - Cielo transactions.  - Redecard customer validation with CyberSource Latin American Processing.
     * @return $this
     */
    ...
    /**
     * Sets phoneNumber
     * @param string $phoneNumber Customer’s phone number.  CyberSource recommends that you include the country code when the order is from outside the U.S.  For processor-specific information, see the customer_phone field in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html)
     * @return $this
     */
