...
function SetupCompletionWithSecureStorageToken()
{
...
if (!defined('DO_NOT_RUN_SAMPLES')) {
    echo "\nSetupCompletionWithSecureStorageToken Sample Code is Running..." . PHP_EOL;
    SetupCompletionWithSecureStorageToken();
}
?>
