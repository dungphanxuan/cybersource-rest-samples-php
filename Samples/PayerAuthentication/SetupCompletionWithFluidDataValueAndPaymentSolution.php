...
function SetupCompletionWithFluidDataValueAndPaymentSolution()
{
    ...
    $paymentInformationFluidData = new CyberSource\Model\Riskv1authenticationsetupsPaymentInformationFluidData($paymentInformationFluidDataArr);
    ...
    $processingInformation = new CyberSource\Model\Riskv1authenticationsetupsProcessingInformation($processingInformationArr);
