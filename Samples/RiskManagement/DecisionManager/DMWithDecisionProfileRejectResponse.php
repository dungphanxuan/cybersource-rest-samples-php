...
function DMWithDecisionProfileRejectResponse()
{
    ...
    $riskInformation = new CyberSource\Model\Riskv1decisionsRiskInformation($riskInformationArr);
...
if (!defined('DO_NOT_RUN_SAMPLES')) {
    echo "\nDMWithDecisionProfileRejectResponse Sample Code is Running..." . PHP_EOL;
