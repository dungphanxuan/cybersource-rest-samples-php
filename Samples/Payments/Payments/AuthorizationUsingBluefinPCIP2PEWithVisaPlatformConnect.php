...
function AuthorizationUsingBluefinPCIP2PEWithVisaPlatformConnect()
{
...
if (!defined('DO_NOT_RUN_SAMPLES')) {
    echo "\nAuthorizationUsingBluefinPCIP2PEWithVisaPlatformConnect Sample Code is Running..." . PHP_EOL;
    AuthorizationUsingBluefinPCIP2PEWithVisaPlatformConnect();
}
?>
