...
function AuthorizationWithDecisionManagerTravelInformation()
{
...
if (!defined('DO_NOT_RUN_SAMPLES')) {
    echo "\nAuthorizationWithDecisionManagerTravelInformation Sample Code is Running..." . PHP_EOL;
    AuthorizationWithDecisionManagerTravelInformation();
}
?>
