...
function SaleUsingEMVTechnologyWithContactReadTwoForCardPresentEnabledAcquirer()
{
...
if (!defined('DO_NOT_RUN_SAMPLES')) {
    echo "\nSaleUsingEMVTechnologyWithContactReadTwoForCardPresentEnabledAcquirer Sample Code is Running..." . PHP_EOL;
    SaleUsingEMVTechnologyWithContactReadTwoForCardPresentEnabledAcquirer();
}
?>
