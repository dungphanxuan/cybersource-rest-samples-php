...
function SaleUsingEMVTechnologyWithContactlessReadForCardPresentEnabledAcquirer()
{
...
if (!defined('DO_NOT_RUN_SAMPLES')) {
    echo "\nSaleUsingEMVTechnologyWithContactlessReadForCardPresentEnabledAcquirer Sample Code is Running..." . PHP_EOL;
    SaleUsingEMVTechnologyWithContactlessReadForCardPresentEnabledAcquirer();
}
?>
