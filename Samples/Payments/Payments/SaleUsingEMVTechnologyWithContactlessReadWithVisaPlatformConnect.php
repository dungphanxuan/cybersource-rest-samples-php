...
function SaleUsingEMVTechnologyWithContactlessReadWithVisaPlatformConnect()
{
...
if (!defined('DO_NOT_RUN_SAMPLES')) {
    echo "\nSaleUsingEMVTechnologyWithContactlessReadWithVisaPlatformConnect Sample Code is Running..." . PHP_EOL;
    SaleUsingEMVTechnologyWithContactlessReadWithVisaPlatformConnect();
}
?>
