...
function SaleUsingSwipedTrackDataForCardPresentEnabledAcquirer()
{
...
if (!defined('DO_NOT_RUN_SAMPLES')) {
    echo "\nSaleUsingSwipedTrackDataForCardPresentEnabledAcquirer Sample Code is Running..." . PHP_EOL;
    SaleUsingSwipedTrackDataForCardPresentEnabledAcquirer();
}
?>
