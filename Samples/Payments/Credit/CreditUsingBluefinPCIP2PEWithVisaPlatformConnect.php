...
function CreditUsingBluefinPCIP2PEWithVisaPlatformConnect()
{
...
if (!defined('DO_NOT_RUN_SAMPLES')) {
    echo "\nCreditUsingBluefinPCIP2PEWithVisaPlatformConnect Sample Code is Running..." . PHP_EOL;
    CreditUsingBluefinPCIP2PEWithVisaPlatformConnect();
}
?>
