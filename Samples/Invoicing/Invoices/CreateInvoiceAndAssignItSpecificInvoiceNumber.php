...
function CreateInvoiceAndAssignItSpecificInvoiceNumber()
{
...
if (!defined('DO_NOT_RUN_SAMPLES')) {
    echo "\nCreateInvoiceAndAssignItSpecificInvoiceNumber Sample Code is Running..." . PHP_EOL;
    CreateInvoiceAndAssignItSpecificInvoiceNumber();
}
?>
